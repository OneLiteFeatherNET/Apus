...
/**
 * An in-memory, namespace-partitioned {@link WorldSourceRepository} fake -- namespace
 * partitioning is exactly what lets tests prove a source seeded under a different tenant's
 * namespace never surfaces for this one, without needing a real or mocked Kubernetes API server.
 */
